...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/patchelf-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/patchelf-xpack/blog/archive/**',
            '/patchelf-xpack/blog/authors/**',
            '/patchelf-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/patchelf-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/patchelf-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/patchelf-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/patchelf-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, patchelf'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/patchelf-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/patchelf-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/patchelf-xpack/discussions',
            },
            {
