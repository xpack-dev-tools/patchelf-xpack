...
**xPack NixOS PatchELF** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of NixOS PatchELF,
intended for reproducible builds.

<Overview/>

**xPack NixOS PatchELF** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/patchelf-xpack/tree/xpack/scripts).
