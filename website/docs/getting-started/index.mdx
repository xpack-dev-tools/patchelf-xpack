...
title: Getting Started with xPack NixOS PatchELF
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/patchelf-xpack)

## Overview

**xPack NixOS PatchELF** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of NixOS PatchELF,
...
[GitHub Discussions](https://github.com/xpack-dev-tools/patchelf-xpack/discussions/).
...
[`patchelf-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/patchelf-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/patchelf-xpack/): It helps others discover our work.
