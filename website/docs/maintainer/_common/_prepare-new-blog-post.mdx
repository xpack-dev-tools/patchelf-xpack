...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/xpack-dev-tools/patchelf-xpack.git/website run generate-website-blog-post
  ```
...
- **Commit** with the message _**website: blog post release 0.18.0-1.1 published**_
