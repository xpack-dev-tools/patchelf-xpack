...
**@xpack-dev-tools/patchelf** is an xpm package that packs platform specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/patchelf-xpack.git/build-assets/package-lock.json
