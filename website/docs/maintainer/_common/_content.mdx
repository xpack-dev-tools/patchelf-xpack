...
the **[Update the version specific code](http://localhost:3000/patchelf-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
- add entries in the **Bug fixes**; use the following syntax
  ```
  - [[#N](https://github.com/xpack-dev-tools/patchelf-xpack/issues/N)]:
  ```
