...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/patchelf-xpack.git
```
...
- open https://xpack-dev-tools.github.io/patchelf-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fpatchelf)](https://www.npmjs.com/package/@xpack-dev-tools/patchelf/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fpatchelf)](https://www.npmjs.com/package/@xpack-dev-tools/patchelf/)
