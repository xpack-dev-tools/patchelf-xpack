...
named like **xPack NixOS PatchELF v{customField('xpackVersion')}** (mind the dash),
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/patchelf@${customField('xpackVersion')}.${customField('npmSubversion')} latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/patchelf@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack NixOS PatchELF v{customField('xpackVersion')} released**_
