...
# How to get help for the xPack NixOS PatchELF
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/patchelf-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/patchelf-xpack/discussions)
pages.
