...
title: How to get help for patchelf
...
# How to get help for xPack NixOS PatchELF
...
distribution, not to the upstream NixOS PatchELF itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack NixOS PatchELF**
