...
title: Information for xPack NixOS PatchELF maintainers
...
```sh
bash ~/Work/xpack-dev-tools/patchelf-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack NixOS PatchELF v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/patchelf</code>
- <code>npm dist-tag add @xpack-dev-tools/patchelf@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/patchelf</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/patchelf@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/patchelf-xpack/blog/
...
- paste the release name like _**xPack NixOS PatchELF v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
