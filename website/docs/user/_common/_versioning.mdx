...
like <code>0.18.0-<b>1</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>0.18.0-1.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack NixOS PatchELF dependency via
a SemVer expressions
like <code>^0.18.0-1</code> or <code>~0.18.0-1</code>, and
prefer exact matches,
like <code>0.18.0-1.1</code>.
