...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/patchelf /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/patchelf /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/patchelf /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
The Windows versions of **xPack NixOS PatchELF**
are packed as `.zip` files.
Download the latest version named like:

* <code>xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
the <code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\patchelf</code> folder, for
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\patchelf\\xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
* <code>xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/patchelf/xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/patchelf
cd ~/Library/xPacks/patchelf

tar xvf ~/Downloads/xpack-patchelf-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-patchelf-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
...
example <code>/home/ilg/.local/xPacks/patchelf/xpack-patchelf-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/patchelf
cd ~/.local/xPacks/patchelf

tar xvf ~/Downloads/xpack-patchelf-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-patchelf-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
