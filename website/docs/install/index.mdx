...
- <code>xpack-patchelf-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-patchelf-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-patchelf-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-patchelf-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-patchelf-{customField('xpackVersion')}-linux-arm.tar.gz</code>
