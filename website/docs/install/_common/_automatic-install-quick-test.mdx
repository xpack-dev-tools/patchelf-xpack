...
`% ~/Library/xPacks/@xpack-dev-tools/${props.shortName}/0.18.0-1.1/.content/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.shortName}/0.18.0-1.1/.content/bin/${props.programName} --version
${props.branding}0.18.0
`} </CodeBlock>
