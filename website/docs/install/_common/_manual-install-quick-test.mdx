...
`% ~/Library/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-0.18.0-1/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.permalinkName}/xpack-${props.permalinkName}-0.18.0-1/bin/${props.programName} --version
${props.branding}0.18.0
`} </CodeBlock>
