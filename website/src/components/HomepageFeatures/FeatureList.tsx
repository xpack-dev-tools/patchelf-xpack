...
export const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        The <b>xPack Framework</b> aims to automate the installation of <b>multiple versions</b> of development tools that are otherwise not easily available in common software distributions, across multiple platforms (<b>macOS</b>, <b>GNU/Linux</b>).
      </>
    ),
  },
  {
