...
seo_title: Version 0.15.0-1 released
description: Version 0.15.0-1 is the first release of xPack NixOS PatchELF.
keywords:
  - xpack
  - patchelf
  - release
...
Version **0.15.0-1** is the first release of NixOS PatchELF.
