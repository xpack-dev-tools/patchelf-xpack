...
seo_title: Version 0.17.0-1 released
description: Version 0.17.0-1 is a new release of xPack NixOS PatchELF.
keywords:
  - xpack
  - patchelf
  - release
...
Version **0.17.0-1** is a new release; it follows the upstream release.
