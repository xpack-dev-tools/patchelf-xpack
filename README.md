...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/patchelf?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/patchelf/)
...
[project website](https://xpack-dev-tools.github.io/patchelf-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/patchelf-xpack](https://github.com/xpack-dev-tools/patchelf-xpack),
the [v0.18.0-1.1](https://github.com/xpack-dev-tools/patchelf-xpack/tree/v0.18.0-1.1) tree.
