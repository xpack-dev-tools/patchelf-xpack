...
XBB_APPLICATION_NAME=${XBB_APPLICATION_NAME:-"NixOS PatchELF"}

# Used as part of file/folder paths.
XBB_APPLICATION_LOWER_CASE_NAME=${XBB_APPLICATION_LOWER_CASE_NAME:-"patchelf"}
...
declare -a XBB_APPLICATION_DEPENDENCIES=( none )
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( patchelf )
